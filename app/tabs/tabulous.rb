...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      [    :works_tab              ,    'Works'              ,    works_path              ,    true        ,    true        ],
      [    :collections_tab        ,    'Collections'        ,    "*"                     ,    true        ,    true        ],
      [    :journals_subtab        ,    '<i class="icon-th-list"></i> Journals', journals_path        ,    true        ,    true        ],
      [    :books_subtab           ,    '<i class="icon-book"></i> Books', books_path              ,    true        ,    true        ],
      [    :index_tab              ,    'About'              ,    about_path              ,    true        ,    true        ],
      #---------------------------------------------------------------------------------------------------------------------#
      #    TAB NAME                |    DISPLAY TEXT         |    PATH                    |    VISIBLE?    |    ENABLED?    #
      #---------------------------------------------------------------------------------------------------------------------#
    ]
  ...
  config.actions do
    [
      ...
      [    :works              ,    :all_actions    ,    :works_tab              ],
      [    :journals           ,    :all_actions    ,    :journals_subtab        ],
      [    :books              ,    :all_actions    ,    :books_subtab           ],
      [    :index              ,    :all_actions    ,    :index_tab              ],
      #--------------------------------------------------------------------------#
      #    CONTROLLER          |    ACTION          |    TAB                     #
      #--------------------------------------------------------------------------#
    ]
